...
{
public:
    float playerDirectionX = 0;
    float playerDirectionY = 0;
    ...
    cocos2d::Sprite* fish;
    cocos2d::SpriteFrame* fishLooking;
    cocos2d::SpriteFrame* fishShooting;
    ...
    void rotateCharacter(float directionX, float directionY);
    void locateEnemies();
